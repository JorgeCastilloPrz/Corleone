...
class ClassUtils {
  ...
  static Class<?> findInClassPath(String qualifiedName) {
    try {
  ...
  static Object buildClassInstance(Class<?> classType) {
    try {
      return classType.newInstance();
    } catch (InstantiationException e) {
      throw new UncaughtInstantiationException(classType.getCanonicalName());
    } catch (IllegalAccessException e) {
      throw new UncaughtIllegalAccessException(classType.getCanonicalName());
    }
  }
}
