...
public class ToolbarAnimatorImpl implements ToolbarAnimator {
    ...
    @Override
    public void attachToolbarAnimationListener(ToolbarAnimationListener listener) {
    ...
    public void hideInstantToolbar(final View toolbarView) {
        toolbarView.post(new Runnable() {
            @Override
            public void run() {
                ValueAnimator toolbarShowAnim = ObjectAnimator.ofFloat(toolbarView, "translationY", -toolbarView.getBottom());
     ...
     */
    @Override
    public void showDelayedSmoothToolbar(final View toolbarView) {
    ...
    public void showSmoothToolbar(View toolbarView) {
        ValueAnimator toolbarShowAnim = ObjectAnimator.ofFloat(toolbarView, "translationY", -toolbarView.getBottom(), 0);
    ...
    @Override
    public void hideSmoothToolbar(View toolbarView) {
        ValueAnimator toolbarShowAnim = ObjectAnimator.ofFloat(toolbarView, "translationY", -toolbarView.getBottom());
        toolbarShowAnim.setInterpolator(new AccelerateInterpolator());
